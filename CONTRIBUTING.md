...
This module uses functions included in the [puppetlabs/stdlib](https://forge.puppet.com/puppetlabs/stdlib)
module. The `puppetlabs/stdlib` module must be installed in a location
that will be loaded by Bolt to run this module's tests. Typically, the default project `~/.puppetlabs/bolt`
is loaded when running this module's tests. If the module is installed on the modulepath for this project,
you're all set to go. Otherwise, you can install the `puppetlabs/stdlib` module for the default project
...
```powershell
Add-BoltModule -Module puppetlabs/stdlib
```
...
- [Open an
  issue](https://github.com/puppetlabs/puppetlabs-secure_env_vars/issues/new/choose)
  or [track an
  issue](https://github.com/puppetlabs/puppetlabs-secure_env_vars/issues) you are
  patching.
...
- [Open a Pull
  Request](https://github.com/puppetlabs/puppetlabs-secure_env_vars/compare)
